...
def test_post_v1_account():
    ...
    login = "test.testovich.123456"
    password = '123456789'
    email = f"{login}@mail.ru"

    account_api = AccountAPI(host='http://5.63.153.31:5051', headers=headers)
    login_api = Login_API(host='http://5.63.153.31:5051',headers=headers)
    mailapi = MaihogAPI(host='http://5.63.153.31:5025',headers=headers)

    # registering new accounta
    print('\nentered data', login, email)
